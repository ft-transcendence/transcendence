    ...
    <main style={{ padding: "1rem 0" }}>
      ...
      <p>
        ...
        <a
          ...
          title="Got to React Router tutorial"
        >
          this
        </a>
        &nbsp;tutorial.
      ...
      <p>
        {" "}
        Create a <b>customPage.tsx</b> file inside the routes folder
      </p>
      <p>
        {" "}
        Add a <b>new route</b> to <b>index.tsx</b>: <br></br>
      ...
      <p>
        {" "}
        Add a <b>new link</b> to <b>app.tsx</b> : <br></br>
        <pre>{`<Link to="/custom-page">Custom page</Link>`}</pre>
      </p>
      <p> There you go ! You can access your page via its URL.</p>
      <p>
        {" "}
        There is no obligation to add the link to the app.tsx, because either
        way, you'll be able<br></br>
