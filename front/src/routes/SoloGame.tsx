...
import "./Game.css";
import { Coordinates, PaddleProps, StatePaddle, SettingsProps, SettingsState, StateSoloPong, MsgSolo, MsgSoloState, SoloButtonState, SoloButtonProps, PropsSoloPong } from './game.interfaces';
...
class SoloButton extends React.Component< SoloButtonProps, SoloButtonState > {
    ...
    static getDerivedStateFromProps(props: SoloButtonProps, state: SoloButtonState){
      return {
...
export default class SoloGame extends React.Component < PropsSoloPong, StateSoloPong > {
    ...
    async gameLoop() {
      if (this.lock === 0)
      {
        ...
        this.setState({ballX: this.xBall, ballY: this.yBall, paddleLeftY: this.yPaddle,}, () => this.lock = 0);
      }
      return;
    }
    ...
    return (
        <div className='Radial-background'>
            ...
            <div className='Button-msg-zone'>
                    <Message showMsg={!this.state.gameStarted} type={1} score={this.state.player1Score} />
                    <SoloButton showButton={!this.state.gameStarted}  clickHandler={this.startGame} buttonText="Play again" />
                    <SoloButton showButton={!this.state.gameStarted}  clickHandler={this.props.clickHandler} buttonText="Quit" />
            </div>
            <div>
